...
CREATE TABLE ai_training_sessions (
  ...
  training_time_seconds int(11) DEFAULT 0,
...
CREATE TABLE budgets (
  ...
  is_ai_predicted tinyint(1) DEFAULT 0,
...
CREATE TABLE events (
  ...
  conflicted_with_event_id int(11) DEFAULT NULL
) ;
...
INSERT INTO event_attendance (id, event_id, user_id, check_in_datetime, check_out_datetime, attendance_status, created_at, updated_at, check_in_method) VALUES
...
CREATE TABLE event_feedback (
  ...
  venue_rating tinyint(4) DEFAULT NULL CHECK (venue_rating between 1 and 5),
  activities_rating tinyint(4) DEFAULT NULL CHECK (activities_rating between 1 and 5),
  organization_rating tinyint(4) DEFAULT NULL CHECK (organization_rating between 1 and 5),
  comments text DEFAULT NULL,
  is_anonymous tinyint(1) DEFAULT 0,
  can_edit tinyint(1) DEFAULT 1,
  edit_deadline datetime DEFAULT NULL,
  created_at datetime DEFAULT current_timestamp(),
  updated_at datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  registration_process tinyint(4) DEFAULT NULL CHECK (registration_process between 1 and 5),
  speaker_effectiveness tinyint(4) DEFAULT NULL CHECK (speaker_effectiveness between 1 and 5),
  content_relevance tinyint(4) DEFAULT NULL CHECK (content_relevance between 1 and 5),
  net_promoter_score tinyint(4) DEFAULT NULL CHECK (net_promoter_score between 0 and 10),
  key_takeaways text DEFAULT NULL,
  future_interest tinyint(1) DEFAULT NULL
) ;
...
ALTER TABLE events
  ...
  ADD KEY idx_venue_datetime (venue,start_datetime,end_datetime);
...
--
ALTER TABLE ai_training_data
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=21;
...
--
ALTER TABLE equipment
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=37;

--
-- SERIAL for table events
--
ALTER TABLE events
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=67;
...
--
ALTER TABLE event_registrations
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=17;

--
-- SERIAL for table event_status_history
--
ALTER TABLE event_status_history
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=84;

--
-- SERIAL for table notifications
--
ALTER TABLE notifications
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=41;

--
-- SERIAL for table roles
--
ALTER TABLE roles
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=7;

--
-- SERIAL for table students
--
ALTER TABLE students
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=10;
...
--
ALTER TABLE venues
  MODIFY id int(11) NOT NULL SERIAL, SERIAL=8;
