...
def load_training_data():
    ...
    try:
        # Get dedicated training data (Limit 5 to prevent timeout/OOM - USER REQUESTED)
        ...
        # ALSO get completed real events to learn from actual usage (Limit 5 to prevent timeout)
