...
window.EventFormModal = function EventFormModal({
  ...
  React.useEffect(() => {
    if (!budgetData && formData.budget > 0) {
      // Create empty budget breakdown structure
      setBudgetData({
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-2xl" style={{width: '750px', flexShrink: 1, height: '743px', maxHeight: '90vh', display: 'flex', flexDirection: 'column'}}>
          ...
          <div className="mt-4 pt-3 border-t border-slate-200">
            <SmartBudgetBreakdown 
              budgetData={budgetData || {totalBudget: formData.budget || 0, categories: [], breakdown: {}, percentages: []}} 
          ...
          {/* Additional Resources - Simple manual input */}
          <div className="mt-4 pt-3 pb-3 border-t border-slate-200">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="px-3 py-1 bg-teal-600 text-white text-xs rounded hover:bg-teal-700 transition flex items-center gap-1"
              >
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-2 max-h-48 overflow-y-auto">
              {manualResources.length === 0 ? (
                <p className="text-xs text-slate-500 italic py-2">No additional resources added. Click "Add Resource" or use AI Auto-Organize.</p>
              ) : (
                  ...
                  <div key={index} className="flex gap-2 items-start bg-slate-50 p-2 rounded">
                    <div className="flex-1 space-y-2">
                      <input
                        ...
                        placeholder="Resource name (e.g., Security Personnel, First Aid Kit)"
