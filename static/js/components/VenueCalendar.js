...
window.VenueCalendar = function VenueCalendar({ userRole }) {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 md:gap-4 h-full">
      ...
      {/* Header / Controls */}
      <div className="p-2 md:p-3 bg-slate-700 border-b border-slate-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
        <div className="flex items-center gap-2 md:gap-4">
          <h2 className="text-sm md:text-base font-bold text-white">
            {currentDate.toLocaleString('default', { month: 'long', year: 'numeric' })}
          </h2>
          <div className="flex bg-slate-600 rounded-lg p-1">
            <button onClick={() => changeMonth(-1)} className="p-1 hover:bg-slate-500 rounded shadow-sm transition text-white">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <select 
            ...
            className="px-3 py-2 bg-slate-600 border border-slate-500 text-white rounded-lg text-sm focus:ring-2 focus:ring-blue-400 outline-none w-full sm:w-64"
          >
      ...
      <div className="hidden md:flex md:w-64 flex-col bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="bg-slate-700 px-4 py-3 border-b border-slate-800">
