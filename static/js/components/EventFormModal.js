...
window.EventFormModal = function EventFormModal({
  ...
  React.useEffect(() => {
    ...
    // Initialize shared departments when editing
    if (formData.shared_with_departments && Array.isArray(formData.shared_with_departments)) {
      setSharedDepartments(formData.shared_with_departments);
    } else {
