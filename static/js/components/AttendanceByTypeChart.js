// Attendance by Event Type - Clean white cards, no colored backgrounds
    ...
    return React.createElement('div', { className: 'bg-white rounded-lg border border-slate-200 p-6 shadow-sm' },
        React.createElement('div', { className: 'flex items-center gap-3 mb-5' },
            ...
            React.createElement('div', null,
                ...
                React.createElement('p', { className: 'text-xs text-gray-500' }, 'Turnout rates across different event categories')
            )
        ),
        React.createElement('div', { className: 'space-y-4' },
            data.map((type, idx) => {
                ...
                // ALWAYS use white background, only progress bar is colored
                return React.createElement('div', { key: idx, className: 'bg-white rounded-lg p-4 border border-gray-200 transition-all hover:shadow-md' },
                    ...
                    React.createElement('div', { className: 'flex items-center justify-between mt-2 text-xs text-gray-600' },
                        ...
                        React.createElement('span', { className: 'inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-gray-100 text-gray-700 font-medium' },
