...
window.AITrainingDashboard = function AITrainingDashboard() {
  ...
  const [currentView, setCurrentView] = useState('dashboard'); // Track SmartAITrainer view
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-10">
      {/* Performance Overview - Only show on dashboard view */}
      ...
      {currentView === 'dashboard' && <div className="border-t border-slate-200 my-8"></div>}
      ...
      <div>
        ...
        {/* Training Form */}
        <SmartAITrainer onViewChange={setCurrentView} />
      </div>
    </div>
  );
};