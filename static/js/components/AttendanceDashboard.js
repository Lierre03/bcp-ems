...
window.AttendanceDashboard = function AttendanceDashboard() {
    ...
    const [detailMode, setDetailMode] = React.useState('attendance'); // 'registrants', 'attendance'
        ...
        const fetchAttendance = async () => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    setDetailMode(data.mode || 'attendance'); // Set mode from backend
                } else {
                            ...
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                                        {detailMode === 'registrants' ? 'Registration Status' : 'Attendance Status'}
                                    </th>
                                    {detailMode === 'attendance' && (
